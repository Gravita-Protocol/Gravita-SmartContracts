...
//    // Set the Vessel Manager address in the testnet PriceFeed
//     // const res = await testnetPriceFeed.setVesselManagerAddress('0x405143dAe9a8a703a1fE82ad4B65BBFE5505AF63')
//     // res.wait()
//     const recordedVesselManagerAddressTestnet = await testnetPriceFeed.vesselManagerAddress()
//     console.log(`recorded VesselManager Address is ${recordedVesselManagerAddressTestnet}`)
...
//     Therefore, expected gas cost of a getLatestPrice() call is within a Vessel function is (35k - 27.5k)
